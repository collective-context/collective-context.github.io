...
<Aside type="tip" title="Praktischer Tipp">
Ein Task pro Projekt oder Datei in `todo.md` — nicht ein Task pro Bug. Lange Task-Listen verursachen Rückstau. Komplexe Tasks bekommen ein Attachment mit der Aufschlüsselung.
</Aside>
...
2. **todo.md und done.md initialisieren**
...
<LinkCard title="Dual-Agent Pattern" href="/patterns/dual-agent" description="Gemini CLI als Scanner + Claude Code Tab als Fixer — der produktivste Multi-Agent-Workflow." />
<LinkCard title="Multi-Repo Coordination" href="/patterns/multi-repo" description="Eine Claude Code Instanz koordiniert mehrere Repositories via Postbox." />
