...
import { Aside, Badge, FileTree, LinkCard } from '@astrojs/starlight/components';
...
## Empfohlene Stack-Konfiguration <Badge text="CC 2.0" variant="success" />
...
<LinkCard title="Weiter: CLAUDE.md Guide" href="/cc/claude-md" description="Das Projekt-Gedächtnis strukturieren — Konventionen, Tiefe, Anti-Patterns." />
