---
title: AGENTS.md Quickstart Template
description: Fertiges AGENTS.md-Template zum Sofort-Einsetzen — Platzhalter ausfüllen, Setup-Checkliste abhaken, fertig
---

Ein Projekt kopiert diese Datei, füllt die `[PLATZHALTER]` aus, führt die Setup-Checkliste aus — und ist vollständig CC-konform aufgestellt.

**GitHub Raw Download:** Datei direkt kopieren → in Projekt-Root als `AGENTS.md` speichern.
...
- `main` — stabiler Stand, kein direkter Agent-Commit ohne Review
...
- [ ] `mkdir -p postbox/attachments/{todo,cron,done}` ausführen
- [ ] `postbox/todo.md`, `postbox/done.md` und `postbox/cron.md` anlegen
...
*Verwandte Seiten: [AGENTS.md Guide](/cc/agents-md) · [Postbox Pattern](/cc/postbox-pattern) · [Quickstart Setup](/quickstart/setup)*
