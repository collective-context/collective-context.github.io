...
mit eigenen Tools wie `hufi-tui.py` und `claude_memory.py` verwaltbar.
→ [Storage-Architektur](/books/zed-editor/06-storage-architektur/)
...
→ Referenz: [hufi-tui.py im fb-data Repo](https://github.com/collective-context)
...
**Daraus entstand** `hufi-tui.py` — eine mutt-artige "Claude TUI-IDE":
