...
<Aside type="tip" title="KAIZEN-These">
Das Terminal hat 50 Jahre Komposabilität gelernt. GUI-IDEs haben 20 Jahre Abstraktionsschichten gebaut. 2026 gewinnt Komposabilität.
</Aside>
...
<LinkCard title="Tool-Vergleich 2026" href="/terminal/tool-comparison" description="Claude Code, Gemini CLI, Aider, Codex CLI, OpenCode — Stärken und Kosten im direkten Vergleich." />
<LinkCard title="Claude Code Deep-Dive" href="/terminal/claude-code" description="Hooks, MCP, Sub-Agents, CLAUDE.md und Cross-Surface-Workflows im Detail." />
