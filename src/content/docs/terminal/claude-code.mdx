...
Das [Postbox Pattern](/cc/postbox-pattern) macht Claude Code orchestrierbar — auch ohne GUI. `xed-tui.py` (XED /TUI) aus dem [fb-data-Projekt](https://github.com/edikte/fb-data) ist ein Open-Source Session-Browser im mutt-Stil, der den Claude Code Terminal-Workflow zur vollständigen IDE erweitert:
