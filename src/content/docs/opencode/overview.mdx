...
<CardGrid>
  <Card title="Null Vendor-Lock-in" icon="open-book">
    75+ LLM-Provider über [models.dev](https://models.dev) — frei wählbar, ohne Tool-Wechsel.
  </Card>
  <Card title="~113k GitHub-Stars" icon="star">
    Größte Community unter den Open-Source Coding Agents. Oh-My-OpenCode baut drauf auf.
  </Card>
  <Card title="TUI-First, ~40 MB RAM" icon="laptop">
    Von Neovim-Nutzern gebaut. SSH-fähig, Electron-frei, pipe-kompatibel.
  </Card>
  <Card title="Native ZED + ACP" icon="approve-check">
...
<LinkCard title="OpenCode in ZED via ACP" href="/opencode/zed-integration" description="OpenCode als ACP-Agent im ZED Editor einrichten — Schritt für Schritt." />
<LinkCard title="Dual-Agent Patterns mit OpenCode" href="/opencode/dual-agent" description="OpenCode als Scanner oder Fixer im Multi-Agent-Workflow." />
