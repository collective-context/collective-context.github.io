...
|---|---|---|---|
| **Claude Agent** | ACP External | Sonnet 4.6 (Max) | <Badge text="Stabil" variant="success" /> |
| **Gemini CLI** | ACP External | Gemini 3.1 Pro | <Badge text="Stabil" variant="success" /> |
| **Codex** | ACP External | GPT-5.2-Codex | <Badge text="Stabil" variant="success" /> |
| **GitHub Copilot** | ACP External | GPT-4o | <Badge text="Stabil" variant="success" /> |
| **Cline** | ACP External | Wählbar | <Badge text="Stabil" variant="success" /> |
| **OpenCode** | ACP External | Wählbar | <Badge text="Beta" variant="caution" /> |
| **Ollama Adapter** | ACP External | Lokal | <Badge text="Community" variant="note" /> |
...
<LinkCard title="Claude Code Tab einrichten" href="/zed/claude-code-tab" description="Hooks, MCP, Sub-Agents, Inline Diffs — alle Features des ZED Claude Code Tabs erklärt." />
