...
description: Developers, Freelancer und Teams die mit AI-Agenten im Terminal arbeiten.
---

## Du arbeitest mit Claude Code, Gemini CLI oder anderen Terminal-Agenten?

Dann ist Collective Context für dich. Wir dokumentieren die Werkzeuge,
Patterns und Best Practices für professionelles Agentic Coding im Terminal.

**Was du hier findest:**

- **🔧 Setup:** ZED Editor + Claude Code Tab + XED /TUI in 15 Minuten installieren
- **💡 Konzepte:** Warum Terminal? Was ist ACP? Welche Tools gibt es 2026?
- **🎭 Patterns:** Bewährte Multi-Agent-Workflows (Orchestra, Pipeline, Dual-Agent)
- **📖 Bibliothek:** Bücher und Deep-Dives zum Nachschlagen

→ [Setup starten →](/zed/overview/)
