...
<Aside type="note" title="Session History: ZED ist mehr als ein Editor">
...
- Terminal-Browser (XED /TUI / `xed-tui.py`): Sessions lesen, annotieren, umbenennen, löschen
...
- **Community ACP Adapter**: <Badge text="Beta" variant="caution" /> (Stand Feb 2026), nicht für Produktions-Einsatz
