...
Du baust deine Website mit [Publii](#was-ist-publii), [Vercel](#kompatibilität-mit-vercel), Jekyll, Hugo oder einem anderen Static Site Generator — und willst sie auf deinem **cBUZZ.IO Hosting-Server** live haben.
...
<CardGrid>
  ...
  <Card title="Web-Agenturen" icon="group">
...
[Publii](https://getpublii.com/) ist ein Desktop-CMS für statische Websites — entwickelt für Content-Creator, die volle Kontrolle über ihre Inhalte wollen, ohne Server-Kenntnisse zu brauchen.
